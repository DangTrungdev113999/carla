...
?>
		...
		<main class="product-page-content-2">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<section class="product-section-2">
							<div class="product-preview">
								<div class="big-slider-2 photoswipe" itemscope itemtype="http://schema.org/ImageGallery">
									<div class="slider-card">
										<a href="img/product-page-big-2.jpg" itemprop="contentUrl" data-size="458x600">
											<img src="public/img/product-page-big-2.jpg" itemprop="thumbnail" alt="Image description">
										</a>
									</div>
									<div class="slider-card">
										<a href="img/product-page-big-2-2.jpg" itemprop="contentUrl" data-size="458x600">
											<img src="public/img/product-page-big-2-2.jpg" itemprop="thumbnail" alt="Image description">
										</a>
									</div>
									<div class="slider-card">
										<a href="img/product-page-big-2-3.jpg" itemprop="contentUrl" data-size="458x600">
											<img src="public/img/product-page-big-2-3.jpg" itemprop="thumbnail" alt="Image description">
										</a>
									</div>
								</div>
								<div class="nav-slider-2-wrap">
									<div class="nav-slider-2">
										<div class="slider-card">
											<img src="public/img/product-page-sm-2-1.jpg" alt="img">
										</div>
										<div class="slider-card">
											<img src="public/img/product-page-sm-2-2.jpg" alt="img">
										</div>
										<div class="slider-card">
											<img src="public/img/product-page-sm-2-3.jpg" alt="img">
										</div>
									</div>
									<button type="button" class="nav-slider prev"><span class="mdi mdi-arrow-left"></span></button>
									<button type="button" class="nav-slider next"><span class="mdi mdi-arrow-right"></span></button>
								</div>
							</div>
