...
?>
		...
		<main class="product-page-content-3">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<section class="product-section-3">
							<div class="product-preview">
								<div class="big-slider-3 photoswipe" itemscope itemtype="http://schema.org/ImageGallery">
									<div class="slider-card">
										<a href="img/product-page-big-tile-1.jpg" itemprop="contentUrl" data-size="263x300">
											<img src="public/img/product-page-big-tile-1.jpg" itemprop="thumbnail" alt="Image description">
										</a>
									</div>
									<div class="slider-card">
										<a href="img/product-page-big-tile-2.jpg" itemprop="contentUrl" data-size="263x300">
											<img src="public/img/product-page-big-tile-2.jpg" itemprop="thumbnail" alt="Image description">
										</a>
									</div>
									<div class="slider-card">
										<a href="img/product-page-big-tile-3.jpg" itemprop="contentUrl" data-size="263x300">
											<img src="public/img/product-page-big-tile-3.jpg" itemprop="thumbnail" alt="Image description">
										</a>
									</div>
									<div class="slider-card">
										<a href="img/product-page-big-tile-4.jpg" itemprop="contentUrl" data-size="263x300">
											<img src="public/img/product-page-big-tile-4.jpg" itemprop="thumbnail" alt="Image description">
										</a>
									</div>
								</div>
							</div>
