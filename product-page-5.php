...
?>
		...
		<section class="page-name">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h1>Product Page 5</h1>
						<ul class="bread-crumbs">
							<li><a href="index.php">Home</a></li>
							<li><p>Pages</p></li>
							<li><p>Product Page 5</p></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<main class="product-page-content-5">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<section class="product-section-5">
							<div class="product-preview">
								<div class="big-slider-5 photoswipe" itemscope itemtype="http://schema.org/ImageGallery">
									<div class="slider-card">
										<a href="img/product-page-big-5-1.jpg" itemprop="contentUrl" data-size="555x600">
											<img src="public/img/product-page-big-5-1.jpg" itemprop="thumbnail" alt="Image description">
										</a>
									</div>
									<div class="slider-card">
							...
							<div class="product-section-description all-description sticky-desc">
