    ...
    <div style="display: table-cell; vertical-align: middle; padding: 0 40px;">
        <div style="margin-left: auto; margin-right: auto; width: 520px;">
            ...
            <div id="fix_details">
                ...
                <br>
                <input type="button" value="Техническая проверка сайта" class="fix_button" onclick="location.href = 'https://adm.tools/troubleshooting/?host=carla-html.buzline.org&error=424&request=XOj8FMxJIDcktNS@TtIt9wAAACY&time=2019-05-25%2011:25:56'">
                <br><br>
