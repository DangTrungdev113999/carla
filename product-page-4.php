...
?>
		...
		<section class="page-name">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h1>Product Page 4</h1>
						<ul class="bread-crumbs">
							<li><a href="index.html">Home</a></li>
							<li><p>Pages</p></li>
							<li><p>Product Page 4</p></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<main class="product-page-content-4">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<section class="product-section-4">
							<div class="product-section-description all-description sticky-desc sticky-left" data-test="1">
							...
							<div class="product-preview">
								<div class="big-slider-4 photoswipe" itemscope itemtype="http://schema.org/ImageGallery">
									<div class="slider-card">
										<a href="img/product-page-big-4-1.jpg" itemprop="contentUrl" data-size="555x600">
											<img src="public/img/product-page-big-4-1.jpg" itemprop="thumbnail" alt="Image description">
										</a>
									</div>
									<div class="slider-card">
										<a href="img/product-page-big-5-2.jpg" itemprop="contentUrl" data-size="555x600">
											<img src="public/img/product-page-big-5-2.jpg" itemprop="thumbnail" alt="Image description">
										</a>
									</div>
									<div class="slider-card">
										<a href="img/product-page-big-5-3.jpg" itemprop="contentUrl" data-size="555x600">
											<img src="public/img/product-page-big-5-3.jpg" itemprop="thumbnail" alt="Image description">
										</a>
									</div>
								</div>
							</div>
							<div class="product-section-description all-description sticky-desc sticky-right" data-test="2">
								<div class="product-available">
									<div class="available">
										<div class="left">
								...
								<div class="related-product">
									<div class="product-card">
										...
										<div class="product-card-info">
											...
											<a href="product-card.html" class="h4">Beige Sweater</a>
											<p class="price">$133 <span class="sale">$290</span></p>
										</div>
									</div>
								</div>
								<div class="related-product">
									<div class="product-card">
										...
										<div class="product-card-info">
											...
											<a href="product-card.html" class="h4">Pink Sweater</a>
											<p class="price">$100</p>
										</div>
									</div>
								</div>
								<div class="related-product">
									<div class="product-card">
										...
										<div class="product-card-info">
											...
											<a href="product-card.html" class="h4">Gray Sweater</a>
											<p class="price">$130</p>
										</div>
									</div>
								</div>
								<div class="related-product">
									<div class="product-card">
										...
										<div class="product-card-info">
											...
											<a href="product-card.html" class="h4">Denim Shirt</a>
											<p class="price">$125</p>
										</div>
									</div>
								</div>
