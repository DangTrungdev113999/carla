                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-11" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="index.php?module=addCategory">Add new</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="index.php?module=categories">list</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-12" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="index.php?module=addProduct">Add new</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="index.php?module=products">list</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-13" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="index.php?module=addProductImage">Add new</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="index.php?module=productImages">list</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
