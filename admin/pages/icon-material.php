                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Material Icons </h2>
                                ...
                                <div class="card-body">
                                    <div class="material-icon-list-demo">
                                        <div class="row icons" id="icons">
                                            ...
                                            <div class="m-icon"><i class="m-r-10 mdi mdi-shadashboard-circle-plus"></i><code class="m-r-10">f65d</code><span>mdi-shadashboard-circle-plus</span></div>
                                            <div class="m-icon"><i class="m-r-10 mdi mdi-shadashboard-plus"></i><code class="m-r-10">f495</code><span>mdi-shadashboard-plus</span></div>
                                            <div class="m-icon"><i class="m-r-10 mdi mdi-shadashboard-polygon-plus"></i><code class="m-r-10">f65e</code><span>mdi-shadashboard-polygon-plus</span></div>
                                            <div class="m-icon"><i class="m-r-10 mdi mdi-shadashboard-rectangle-plus"></i><code class="m-r-10">f65f</code><span>mdi-shadashboard-rectangle-plus</span></div>
                                            <div class="m-icon"><i class="m-r-10 mdi mdi-shadashboard-square-plus"></i><code class="m-r-10">f660</code><span>mdi-shadashboard-square-plus</span></div>
                                            ...
                                            <div class="m-icon"><i class="m-r-10 mdi mdi-skydashboard-business"></i><code class="m-r-10">f4b0</code><span>mdi-skydashboard-business</span></div>
