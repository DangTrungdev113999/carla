                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body pt-2">
                                    ...
                                    <div class="media mb-3">
                                        <!-- .user-avatar -->
                                        <a href="user-profile.php" class="user-avatar user-avatar-floated user-avatar-xl float-left mr-3">
                            <img src="../assets/images/avatar-1.jpg" alt="User Avatar" class="rounded-circle user-avatar-xl">
                              ...
                              <a href="user-profile.php">John Abraham</a>
                            </h3>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card card-fluid">
                                ...
                                <div class="card-body text-center">
                                    <!-- .user-avatar -->
                                    <a href="user-profile.php" class="user-avatar user-avatar-floated user-avatar-xl">
                                   <img src="../assets/images/avatar-1.jpg" alt="User Avatar" class="rounded-circle user-avatar-xl">
                                    </a>
                                    <!-- /.user-avatar -->
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                            <div class="card card-fluid">
                                ...
                                <div class="card-body text-center">
                                    <!-- .user-avatar -->
                                    <a href="user-profile.php" class="user-avatar my-3">
                                  <img src="../assets/images/avatar-1.jpg" alt="User Avatar" class="rounded-circle user-avatar-xl">
                                   </a>
                                    <!-- /.user-avatar -->
                                    <h3 class="card-title mb-2 text-truncate">
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card card-fluid">
                                ...
                                <div class="card-body text-center">
                                    <!-- .user-avatar -->
                                    <a href="user-profile.php" class="user-avatar user-avatar-xl my-3">
                                      <img src="../assets/images/avatar-1.jpg" alt="User Avatar" class="rounded-circle user-avatar-xl">
                                          </a>
                                    <!-- /.user-avatar -->
                                    <h3 class="card-title mb-2 text-truncate">
                                        <a href="user-profile.php">Beni Arisandi</a>
                                        </h3>
                                    <h6 class="card-subtitle text-muted mb-3"> Product Designer @CreativeDivision </h6>
                                    <p>
                            ...
                            <div class="card card-fluid">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="media align-items-center">
                                        <!-- .user-avatar -->
                                        <a href="user-profile.php" class="user-avatar user-avatar-xl mr-3">
                            <img src="../assets/images/avatar-1.jpg" alt="User Avatar" class="rounded-circle user-avatar-xl">
                          </a>
                                        <!-- /.user-avatar -->
                                        <!-- .media-body -->
