                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Fontawesome Icons </h2>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="icon-list-demo row">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-3 f-icon"><i class="fas fa-envelodashboard-open"></i> fas fa-envelodashboard-open</div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 f-icon"><i class="fas fa-envelodashboard-square"></i> fas fa-envelodashboard-square
                                        </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="icon-list-demo row">
                                    ...
                                    <div class="col-sm-6 col-md-4 col-lg-3 f-icon"><i class="far fa-envelodashboard-open"></i><span> far fa-envelodashboard-open</span></div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="clearfix icon-list-demo row">
                                    ...
                                    <div class="col-sm-6 col-md-4 col-lg-3 f-icon"><i class="fab fa-stridashboard-s"></i><span> fab fa-stridashboard-s</span></div>
