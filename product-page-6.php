...
?>
		...
		<section class="page-name">
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h1>Product Page 6</h1>
						<ul class="bread-crumbs">
							<li><a href="index.php">Home</a></li>
							<li><p>Pages</p></li>
							<li><p>Product Page 6</p></li>
						</ul>
					</div>
				</div>
			</div>
		...
		<main class="product-page-content-6">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<section class="product-section-6">
							<div class="product-preview">
								<div class="vertical-slider-6-wrap">
									<div class="vertical-slider-6">
										<div class="slider-card">
											<img src="public/img/product-page-sm-6-1.jpg" alt="img">
										</div>
										<div class="slider-card">
											<img src="public/img/product-page-sm-6-2.jpg" alt="img">
										</div>
										<div class="slider-card">
											<img src="public/img/product-page-sm-6-3.jpg" alt="img">
										</div>
										<div class="slider-card">
											<img src="public/img/product-page-sm-6-4.jpg" alt="img">
										</div>
										<div class="slider-card">
											<img src="public/img/product-page-sm-6-5.jpg" alt="img">
										</div>
										<div class="slider-card">
											<img src="public/img/product-page-sm-6-3.jpg" alt="img">
										</div>
								...
								<div class="big-slider-6 photoswipe" itemscope itemtype="http://schema.org/ImageGallery">
									<div class="slider-card">
										<a href="img/product-page-big-6.jpg" itemprop="contentUrl" data-size="458x600">
											<img src="public/img/product-page-big-6.jpg" itemprop="thumbnail" alt="Image description">
										</a>
									</div>
									<div class="slider-card">
										<a href="img/product-page-big-6-2.jpg" itemprop="contentUrl" data-size="458x600">
											<img src="public/img/product-page-big-6-2.jpg" itemprop="thumbnail" alt="Image description">
										</a>
									</div>
									<div class="slider-card">
										<a href="img/product-page-big-6-1.jpg" itemprop="contentUrl" data-size="458x600">
											<img src="public/img/product-page-big-6-1.jpg" itemprop="thumbnail" alt="Image description">
										</a>
									</div>
									<div class="slider-card">
										<a href="img/product-page-big-6.jpg" itemprop="contentUrl" data-size="458x600">
							...
							<div class="tab-wrap">
								...
								<div class="tab-body-wrap">
									...
									<div class="tab-content" id="tab-1">
										...
										<ul class="tab-product-list photoswipe" itemscope itemtype="http://schema.org/ImageGallery">
											<li>
												<a href="img/tab-product-1.jpg" itemprop="contentUrl" data-size="263x330">
													<img src="public/img/tab-product-1.jpg" alt="img" itemprop="thumbnail">
												</a>
											</li>
											<li>
												<a href="img/tab-product-2.jpg" itemprop="contentUrl" data-size="263x330">
													<img src="public/img/tab-product-2.jpg" alt="img" itemprop="thumbnail">
												</a>
											</li>
											<li>
												<a href="img/tab-product-3.jpg" itemprop="contentUrl" data-size="263x330">
													<img src="public/img/tab-product-3.jpg" alt="img" itemprop="thumbnail">
												</a>
											</li>
											<li>
												<a href="img/tab-product-4.jpg" itemprop="contentUrl" data-size="263x330">
													<img src="public/img/tab-product-4.jpg" alt="img" itemprop="thumbnail">
												</a>
											</li>
										</ul>
									</div>
